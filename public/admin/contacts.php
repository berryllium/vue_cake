...
if (isset($_POST['contacts'])) {
  extract($_POST);
  $query = "UPDATE `contacts` SET `phone` = '$phone', `email` = '$email', `address` = '$address', `work` = '$work', `header` = '$header', `hometext` = '$hometext', `about` = '$about', `delivery` = '$delivery' WHERE `contacts`.`id` = 1";
